...
public class RegisterRSAcademyPage  extends CommonUtilities {
	WebDriver driver;

    public RegisterRSAcademyPage(WebDriver driver) {
        super(driver);    
        this.driver=driver;
    ...
    public void enterValue_userNameField(String user_name) {
        username.sendKeys(user_name);
    }

    public void enterValue_usereMailField(String user_email) {
        useremail.sendKeys(user_email);
    }

    public void enterValue_passwordField(String user_password) {
